...
class OnlineTestBegin extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 0) {
            l.setText("Que1: Which of the following is not an OOPS concept in Java?");
        ...
        if (current == 1) {
            l.setText("Que2: Which of these statements is incorrect about Thread?");
            jb[0].setText("start() method is used to begin execution of the thread");
            jb[1].setText("run() method is used to begin execution of a thread before start() method in special cases");
        ...
        if (current == 4) {
            l.setText("Que5: A thread can be formed by a class that extends Thread class ?");
            jb[0].setText("This command is used to run the Java compiler");
            jb[1].setText("A command to run a non-optimized version of the Java compiler");
            jb[2].setText("A command to create an HTML document in API style");
            jb[3].setText("A command to separate Java class files");
        }
        if (current == 5) {
